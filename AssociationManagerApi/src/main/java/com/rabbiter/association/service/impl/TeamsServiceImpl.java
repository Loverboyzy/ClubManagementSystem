...
public class TeamsServiceImpl implements TeamsService {
    ...
    public PageData parsePage(Page<Teams> p) {
        ...
        for (Teams teams : p.getRecords()) {
            ...
            temp.put("managerName", user != null ? user.getName() : null);
            temp.put("managerPhone", user != null ? user.getPhone() : null);
            temp.put("managerAddress", user != null ? user.getAddress() : null);

            TeamTypes teamType = teamTypesDao.selectById(teams.getTypeId());
            temp.put("typeId", teams.getTypeId());
            temp.put("typeName", teamType != null ? teamType.getName() : null);
            resl.add(temp);
        }
