    ...
    <el-header class="fater-header">
        <div class="fater-header-logo">
            <el-row :gutter="16">
                ...
                <el-col :span="18" style="font-size: 22px; font-weight: 600; letter-spacing: 1px;">
                    社团管理系统
                </el-col>
            </el-row>
        </div>
        <el-dropdown @command="handleUser" class="fater-header-user">
            <span class="el-dropdown-link">
                <el-row>
                    ...
                    <el-col :span="17" style="font-size: 18px; font-weight: 600; text-align: center; line-height: 60px;">
